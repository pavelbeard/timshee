...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "mjml_templates", BASE_DIR / "stuff", BASE_DIR / "order"],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
SIMPLE_JWT = {
    ...
    "SIGNING_KEY": os.getenv(
        "DJANGO_SECRET_KEY", "czrFjA4W3BaOfKpzo6eiSOiek42BWQN_RQ6fO-jL5yg"
    ),
    "VERIFYING_KEY": None,
...
## MJML
MJML_BACKEND_MODE = "httpserver" # noqa
MJML_HTTPSERVERS = [ # noqa
    {
    ...
    {
        "URL": os.getenv(
            "MJML_OWN_SERVER_URL", "http://localhost:15500/v1/render"
