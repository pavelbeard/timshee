...
export const selectIsChangeEmailFormOpen = (state) =>
  state.ui.isChangeEmailFormOpen;
...
export const selectIsSignInAtCheckoutChecked = (state) =>
  state.ui.isSignInAtCheckoutChecked;
