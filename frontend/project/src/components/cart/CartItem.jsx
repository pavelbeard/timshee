  ...
  return (
    <div className="flex justify-center p-6">
      <section
        ...
        data-cart-item-id={cartItem?.stock_item?.id}
      >
        <Link to={itemLink(cartItem?.stock_item)} data-cart-item-image="">
          <ItemImage
        ...
        <div className="lg:ml-4" data-cart-item="">
          <section className="flex flex-col" data-cart-item-info="">
            <div className="flex justify-between p-1">
              <span className="roboto-text">
                {cartItem?.stock_item?.item?.name}
              </span>
              <span className="roboto-text">
                {cartItem?.stock_item?.item?.price}
              </span>
            </div>
            <div className="flex justify-between lg:flex-col p-1">
              <span className="roboto-text">
                {cartItem?.stock_item?.size?.value}
              </span>
              <span className="roboto-text">
                {cartItem?.stock_item?.color?.name}
              </span>
            </div>
          </section>
          <section
            className="flex justify-between items-center"
            data-cart-item-quantity-panel=""
          >
          ...
          <section
            ...
            data-delete-item-panel=""
          >
            <button onClick={remove} className="underlined-button">
              {t("cart:remove")}
            </button>
          </section>
        </div>
