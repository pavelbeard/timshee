...
import {setShippingMethod} from "../../../../main/order(old)/checkout(old)/pages/forms/reducers/shippingAddressFormSlice";
import {useDispatch, useSelector} from "react-redux";
import t from "../../../../main/translate(old)/TranslateService";
import { putShippingMethod } from "../../../../main/order(old)/checkout(old)/pages/forms/lib/update";
import AuthService from "../../../../main/api(old)/authService";
import {getOrderDetail, updateOrderShippingMethod} from "../../../../main/order(old)/api/asyncThunks";
