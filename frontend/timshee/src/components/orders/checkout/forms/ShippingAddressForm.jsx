...
import backImg from "../../../../assets/back_to.svg"
import {useDispatch, useSelector} from "react-redux";
import {
    setAddressFormObject,
} from "../../../../main/order(old)/checkout(old)/pages/forms/reducers/shippingAddressFormSlice";
    import {toggleCart} from "../../../../redux(old)/slices/menuSlice";
import AuthService from "../../../../main/api(old)/authService";
import {getFilteredPhoneCodes, getFilteredProvinces} from "../../../../main/order(old)/api/asyncThunks";
import t from "../../../../main/translate(old)/TranslateService";
import {clsx} from "clsx";
import {putAddress} from "../../../../main/order(old)/checkout(old)/pages/forms/lib/update";
import {getAddresses} from "../../../../main/order(old)/checkout(old)/pages/forms/lib/read";
