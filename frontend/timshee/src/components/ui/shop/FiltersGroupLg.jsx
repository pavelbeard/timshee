...
import FiltersSelectContainerLg from "./FiltersSelectContainerLg";
        ...
        <div>
            ...
            <div className="lg:flex lg:relative lg:z-10 lg:mt-2">
                <FilterBlockLg  title={t('shop:size')}>
                    ...
                    >
                        <Checkboxes data={sizes} htmlFor={'value'} labelTextKey={'value'} category={'sizes'} idKey={'value'} />
                    </FilterDropdown>
                </FilterBlockLg>
                <FilterBlockLg  title={t('shop:color')}>
                    ...
                    >
                        <Checkboxes data={colors} htmlFor={'hex'} labelTextKey={'name'} category={'colors'} idKey={'hex'} />
                    </FilterDropdown>
                </FilterBlockLg>
                <FilterBlockLg  title={t('shop:type')}>
                    ...
                    >
                        <Checkboxes data={types} htmlFor={'code'} labelTextKey={'name'} category={'types'} idKey={'code'} />
                    </FilterDropdown>
                </FilterBlockLg>
                <FilterBlockLg  title={t('shop:collection')}>
                    ...
                    >
                        <Checkboxes data={collections} htmlFor={'link'} labelTextKey={'name'} category={'collections'} idKey={'link'} />
                    </FilterDropdown>
                </FilterBlockLg>
                <FilterBlockLg  title={t('shop:category')}>
                    ...
                    >
                        <Checkboxes data={categories} htmlFor={'code'} labelTextKey={'name'} category={'categories'} idKey={'code'} />
                    </FilterDropdown>
                </FilterBlockLg>
            </div>
        </div>
