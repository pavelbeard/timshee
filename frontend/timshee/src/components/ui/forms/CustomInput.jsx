...
export default function CustomInput({
    ...
    const types = {
        ...
        password: <div className={divWfull}>
            <label
                htmlFor={htmlFor}
                className={clsx(labelClassName, commonLabelStyle, ifNotCheckboxOrRadio)}
            >
                ...
                <input
                    ...
                    {...rest}
                    id={htmlFor}
                    className={clsx(className, commonInputStyle, borderBottomStyle, 'pr-5')}
                />
                {isPasswordRevealed
        ...
        checkbox: <label
            htmlFor={htmlFor}
            className={clsx(labelClassName, commonLabelStyle, ifCheckboxOrRadio, 'relative')}
        >
            <span className={clsx(commonSpanStyle, '')}>{labelText}</span>
            <input
                type="checkbox"
