                    ...
                    <div key={index}>
                        ...
                        <div className="flex flex-col">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="roboto-text">{w.stock?.item?.price}
                                    <span className="roboto-text">{t('shop:price')}</span></span>
                            </div>
                        ...
                        <div className={clsx('pb-6')}>
                            <button className="underlined-button" onClick={() => deleteItemFromWL(w.id)}>
