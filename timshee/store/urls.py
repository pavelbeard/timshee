...
urlpatterns = (
    ...
    path("round-images/", views.RoundImageListCreateAPIView.as_view(), name="round-image-list-create"),
    path("round-images/<int:pk>/", views.RoundImageRetrieveDestroyAPIView.as_view(), name="round-image-detail"),
    ...
    path("size-colors/", views.SizeColorListCreateAPIView.as_view(), name="size-color-list-create"),
    path("size-colors/<int:pk>/", views.SizeColorRetrieveDestroyAPIView.as_view(), name="size-color-detail"),
